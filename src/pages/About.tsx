    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-primary-100 to-primary-200 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full text-sm text-primary-700 font-medium mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-primary-700 mb-8">
            Tina
          </h1>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl mb-16">
          <div className="prose prose-lg text-primary-700 leading-relaxed space-y-6 max-w-none">
            <p>
            ...
            <p className="text-xl font-medium text-primary-800 text-center py-4 border-t border-b border-primary-200 my-8">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-br from-primary-100 to-primary-200 rounded-3xl p-8 md:p-12 shadow-lg">
            ...
            <p className="text-lg text-primary-600 leading-relaxed mb-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/community"
                className="bg-gradient-to-r from-primary-600 to-primary-500 text-white px-8 py-3 rounded-full font-medium hover:shadow-lg transition-all duration-300"
              >
                Join Our Community
              </a>
              <a
                href="/coaching"
                className="border-2 border-primary-600 text-primary-600 px-8 py-3 rounded-full font-medium hover:bg-primary-50 transition-colors duration-300"
              >
                Work Together
              </a>
            </div>

            <p className="text-sm text-primary-500 mt-8 italic">
